Public Class clsSupplierCommission
    Inherits clsBase
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If strItmsGrp <> "" Then
                ...
                If strCode <> "" Then
                    ...
                    End If
                Else
                    strCode = oApplication.Utilities.getMaxCode("@Z_OSRE", "Code")
                    oUserTable.Code = strCode
                    oUserTable.Name = strCode
                    oUserTable.UserFields.Fields.Item("U_Z_COGS").Value = oGrid.DataTable.GetValue("U_Z_COGS", intRow)
                    oUserTable.UserFields.Fields.Item("U_Z_Accrual").Value = oGrid.DataTable.GetValue("U_Z_Accrual", intRow)
...
#End Region
    Private Function validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        Try
            oGrid = aForm.Items.Item("5").Specific
            For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
                If oGrid.DataTable.GetValue("U_Z_ItmsGrp", intRow) <> "" Then
                    If oGrid.DataTable.GetValue("U_Z_COGS", intRow) = "" Then
                        oApplication.Utilities.Message("COGS Account is missing", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        Return False
                    End If
                    If oGrid.DataTable.GetValue("U_Z_Accrual", intRow) = "" Then
